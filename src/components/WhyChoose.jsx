        ...
        <section className="bg-slate-100 px-10 pt-[7rem]">
          ...
          <div className="flex flex-col md:flex-row justify-center   align-middle">
            <article>
                ...
                <p>Lorem ipsum dolor sit, am consectetur adipisdfgdicing elit. Minus explicabo ex deleniti possimus consectetur tempora dolorem eligendi repellat culpa dignissimos?</p>
            </article>
            <article>
                <div className="">
