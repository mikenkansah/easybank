...
const Navbar = () => {
  return (
    <nav className="navbar flex justify-between py-4 px-10 border shadow-lg bg-white shadow-slate-300 box-border relative z-[20]">
     ...
     <button className="btn bg-gradient-to-r from-green-400 to-blue-500 border border-blue-800 rounded-3xl outline-none text-white py-2 px-5 hover:opacity-[0.7]" type="button">Request Invite</button>
    </nav>
  );
};
